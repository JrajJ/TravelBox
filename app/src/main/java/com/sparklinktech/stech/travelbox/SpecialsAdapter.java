...
public class SpecialsAdapter extends RecyclerView.Adapter<SpecialsAdapter.ViewHolder> implements Filterable
{
    private ArrayList<Restaurant> mArrayList;
    private ArrayList<Restaurant> mFilteredList;
    private Context ctx ;

    SpecialsAdapter(ArrayList<Restaurant> arrayList)
    {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull SpecialsAdapter.ViewHolder holder)
    {
    ...
    @NonNull
    @Override
    public SpecialsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {

        View view = LayoutInflater.from(viewGroup.getContext()).inflate(
                R.layout.custom_specials, viewGroup, false);

        return new SpecialsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SpecialsAdapter.ViewHolder viewHolder, int i)
    {
        ...
        Log.e("width   =   ",""+width);
        Log.e("height   =   ",""+height);
        // 1920/3 = 640-100 = 540                 1280/3 = 427-100 = 327
        if(width<=720||height<=1280)
        {
            Picasso.with(ctx).load(R.drawable.h3).resize(
                    width-100,(height/3))
                    .into(viewHolder.iv);
            }
